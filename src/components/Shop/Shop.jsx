...
function Shop() {
  ...
  function productDetail(product, event) {
          ...
          <div id="order">
            <div className="flex flex-wrap justify-evenly">
              ...
              <div className="w-[606.01px] h-[730.87px] p-4">
                ...
                <p className="text-slate-500">Size</p>
                <div className="flex gap-4">
                  <div className="yellowbg px-2 rounded w-[30px] h-[30px]">
                    L
                  </div>
                  <div className="pinkbg px-2 rounded w-[30px] h-[30px]">
                    XL
                  </div>
                  <div className="lightpinkbg px-2 rounded w-[30px] h-[30px]">
                    XS
